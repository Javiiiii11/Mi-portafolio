...
import { colors, getBackgroundColor, getContactBackgroundColor } from "../common/colors";
...
const tick = () => {
  ...
  const color = sceneWeights.contact > 0.001 ? getContactBackgroundColor() : getBackgroundColor();
